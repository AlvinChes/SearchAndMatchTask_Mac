...
if task_color == 'Color-blind friendly Palette':
    # Colorblind friendly list of colors for polygons taken from:
    # Wong, B., Nature Methods, 2011 (https://doi.org/10.1038/nmeth.1618)
...
class SearchMatchTask:
    ...
    def __init__(self):
        ...
        self.window = visual.Window([WIDTH, HEIGHT], units="pix", monitor=mon,
                                    color=BACKGROUND_COLOR, winType='pyglet', useRetina=True, 
                                    fullscr=False)
